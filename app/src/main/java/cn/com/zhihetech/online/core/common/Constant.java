...
public class Constant implements Serializable, Cloneable {
    ...
    public static String USER_FOCUS_MERCHANTS_URL = HOST + "user/{0}/focusMerchants";    //获取关注商家列表
    public static String CANCEL_FOCUS_MERCHANT_URL = HOST + "cancelFocusMerchant ";    //取消商家收藏
    ...
    public static String ORDER_CANCEL_URL = HOST + "order/{0}/cancel"; //取消指定订单
    public static String ORDER_REFUND_URL = HOST + "order/{0}/refund"; //申请退款
